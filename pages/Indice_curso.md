...
## Obtener y Transformar Datos (Power Query)
  ...
  1.	Conectar a un Archivo de Excel en Uso ( <a href="/downloads/3.Ventas_Por_Pais_1.xlsx"><i class="far fa-file-code"></i> </a>,  <a href="/downloads/3.Ventas_Por_Pais_2.xlsx"><i class="far fa-file-code"></i> </a>)
